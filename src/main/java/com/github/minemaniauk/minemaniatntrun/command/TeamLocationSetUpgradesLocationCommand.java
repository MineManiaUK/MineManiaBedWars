...
public class TeamLocationSetUpgradesLocationCommand implements CondensedCommand {
    ...
    public @Nullable CommandStatus onPlayerUser(@NotNull PlayerUser user, @NotNull CommandArguments arguments, @NotNull CommandStatus status) {
        ...
        teamLocation.setUpgradesLocation(location);
        arena.save();

        // Send a confirmation message.
        user.sendMessage("&a&l> &aThe upgrades location for team &f" + teamLocation.getColor().getName() + " &ais now set to &f" + location);
        return new CommandStatus();
    }
